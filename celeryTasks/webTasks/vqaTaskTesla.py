...
dataFolder = os.path.join(BASE_DIR, 'app', 'executable', 'vqa_files', 'data')
qtok_path = os.path.join(BASE_DIR, 'app', 'executable', 'LSTM+MLP', 'vocab.pkl')
ans_voc_path = os.path.join(BASE_DIR, 'app', 'executable', 'LSTM+MLP', 'top_ans_1000.json')
model_path = os.path.join(BASE_DIR, 'app', 'executable', 'LSTM+MLP', 'model_cloudCV.pkl')
