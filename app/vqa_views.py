"""
I am commenting this for now. If it is to be included in urls and made public,
then write a new and proper celery task in celeryTasks/ making sure that all
the module imports, etc happen inside the function.
"""
